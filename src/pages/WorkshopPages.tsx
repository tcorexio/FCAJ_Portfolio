...
const WORKSHOP_SECTIONS: WorkshopSection[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: "4.2.1-vpc-network",
        folderName: "4.2-Prerequiste/4.2.1-vpc-network",
        en: "4.2.1 VPC Network",
        vi: "4.2.1 Mạng VPC",
      },
      {
        id: "4.2.2-client-facing",
        folderName: "4.2-Prerequiste/4.2.2-client-facing",
        en: "4.2.2 Client Facing",
        vi: "4.2.2 Client Facing",
      },
      {
        id: "4.2.3-backend-platform",
        folderName: "4.2-Prerequiste/4.2.3-backend-platform",
        en: "4.2.3 Backend Platform",
        vi: "4.2.3 Nền Tảng Backend",
      },
      {
        id: "4.2.4-database",
        folderName: "4.2-Prerequiste/4.2.4-database",
        en: "4.2.4 Database",
        vi: "4.2.4 Cơ Sở Dữ Liệu",
      },
    ],
  },
  {
    ...
    children: [
      {
        id: "4.3.1-vpc-network",
        folderName: "4.3-Frontend/4.3.1-vpc-network",
        en: "4.3.1 VPC Network",
        vi: "4.3.1 Mạng VPC",
      },
      {
        id: "4.3.2-frontend-hosting-auth",
        folderName: "4.3-Frontend/4.3.2-frontend-hosting-auth",
        en: "4.3.2 Frontend Hosting & Auth",
        vi: "4.3.2 Hosting & Xác Thực",
      },
      {
        id: "4.3.3-backend",
        folderName: "4.3-Frontend/4.3.3-backend",
        en: "4.3.3 Backend Integration",
        vi: "4.3.3 Kết Nối Backend",
      },
      {
        id: "4.3.4-database",
        folderName: "4.3-Frontend/4.3.4-database",
        en: "4.3.4 Database",
        vi: "4.3.4 Cơ Sở Dữ Liệu",
      },
      {
        id: "4.3.5-platform-edge-ops",
        folderName: "4.3-Frontend/4.3.5-platform-edge-ops",
        en: "4.3.5 Platform & Edge Ops",
        vi: "4.3.5 Platform & Edge Ops",
      },
    ],
  },
  {
    ...
    children: [
      {
        id: "4.4.1-Auth",
        folderName: "4.4-Backend/4.4.1-Auth",
        en: "4.4.1 Authentication",
        vi: "4.4.1 Xác Thực",
      },
      {
        id: "4.4.2-Data",
        folderName: "4.4-Backend/4.4.2-Data",
        en: "4.4.2 Data Layer",
        vi: "4.4.2 Lớp Dữ Liệu",
      },
      {
        id: "4.4.3-Storage",
        folderName: "4.4-Backend/4.4.3-Storage",
        en: "4.4.3 Storage Layer",
        vi: "4.4.3 Lớp Lưu Trữ",
      },
      {
        id: "4.4.4-Functions",
  ...
  },
  {
    ...
    children: [
      {
        id: "4.5.1-VPC-Network",
        folderName: "4.5-ECS-Fargate/4.5.1-VPC-Network",
        en: "4.5.1 VPC & Network",
        vi: "4.5.1 VPC & Mạng",
      },
      {
        id: "4.5.2-Infrastructure",
        folderName: "4.5-ECS-Fargate/4.5.2-Infrastructure",
        en: "4.5.2 Infrastructure",
        vi: "4.5.2 Hạ Tầng",
      },
      {
        id: "4.5.3-NAT-Instance",
        folderName: "4.5-ECS-Fargate/4.5.3-NAT-Instance",
        en: "4.5.3 NAT Optimization",
        vi: "4.5.3 Tối Ưu NAT",
      },
      {
        id: "4.5.4-Fargate-ALB",
        folderName: "4.5-ECS-Fargate/4.5.4-Fargate-ALB",
        en: "4.5.4 Fargate & ALB",
        vi: "4.5.4 Fargate & ALB",
      },
    ],
  },
  {
  ...
  return (
    <AnimatedPage>
      <div className="page-container">
        ...
        <SectionHeader
          icon="workshop"
          title={language === "en" ? "Technical Workshop" : "Workshop Kỹ Thuật"}
        />
...
export function WorkshopSectionPage() {
  ...
  const grandParentMeta = grandParentId
    ? SECTION_MAP.get(grandParentId)
    : undefined;
  const midParentId =
    params.subSubId && params.subId
      ? `${params.sectionId}/${params.subId}`
      : undefined;
  ...
  const crumbs = [
    ...
    ...(grandParentMeta
      ? [
          {
            label: language === "en" ? grandParentMeta.en : grandParentMeta.vi,
            path: `/workshop/${grandParentId}`,
          },
        ]
      : []),
    ...(midParentMeta
      ? [
          {
            label: language === "en" ? midParentMeta.en : midParentMeta.vi,
            path: `/workshop/${params.sectionId}/${params.subId}`,
          },
        ]
      : []),
    ...(parentMeta && !params.subSubId
      ? [
          {
            label: language === "en" ? parentMeta.en : parentMeta.vi,
            path: `/workshop/${parentId}`,
          },
        ]
      : []),
    {
        ...
        {sectionMeta?.children && sectionMeta.children.length > 0 && (
          <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-100 shadow-sm mt-6">
            <h3 className="section-title mb-4">
              {language === "en" ? "Sub-sections" : "Các Mục Con"}
            </h3>
              ...
              {sectionMeta.children.map((child, i) => (
                <li key={child.id}>
                  ...
                  >
                    ...
                    <ChevronRight
                      size={18}
                      className="ml-auto text-gray-400 group-hover:text-accent-orange transition-colors"
                    />
                  </Link>
                </li>
              ))}
