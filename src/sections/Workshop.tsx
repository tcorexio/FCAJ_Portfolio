...
export function Workshop() {
  ...
  const workshopContent = {
    overview: {
      ...
      content: {
        en: `SpendWise is a cloud-native expense management application built on AWS. In this workshop, you will learn how to design, develop, and deploy a full-stack system using modern cloud services.

**What you'll learn:**
- Design scalable architecture on AWS
- Build frontend and backend for an expense tracking system
- Integrate authentication and data storage
- Deploy services using ECS Fargate and serverless components
- Apply best practices for cloud deployment and cost optimization`,

        vi: `SpendWise là ứng dụng quản lý chi tiêu được xây dựng trên nền tảng AWS. Trong workshop này, bạn sẽ học cách thiết kế, phát triển và triển khai một hệ thống full-stack sử dụng các dịch vụ cloud hiện đại.

**Bạn sẽ học:**
- Thiết kế kiến trúc có khả năng mở rộng trên AWS
- Xây dựng frontend và backend cho hệ thống quản lý chi tiêu
- Tích hợp xác thực và lưu trữ dữ liệu
- Triển khai hệ thống với ECS Fargate và serverless
- Áp dụng best practices cho triển khai và tối ưu chi phí`,
      },
    },
    prerequisites: {
      ...
      items: [
        {
          en: "AWS Account with admin access",
          vi: "Tài khoản AWS với quyền admin",
        },
        { en: "AWS CLI configured", vi: "AWS CLI đã được cấu hình" },
        { en: "Node.js 18+ installed", vi: "Node.js 18+ đã được cài đặt" },
        {
          en: "Basic knowledge of AWS services",
          vi: "Kiến thức cơ bản về các dịch vụ AWS",
        },
      ],
    },
    step1: {
    ...
    return (
      <div className="space-y-4">
        <p className="text-text-secondary">
          {stepContent.description[language]}
        </p>
        <CodeBlock
