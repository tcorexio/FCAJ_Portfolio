...
A single apply creates the whole stack, but the resources above are the **network + perimeter** slice. Design rationale: [4.2.1 VPC and networking](../4.2-Prerequiste/4.2.1-vpc-network/).
