...
export const content = {
  ...
  worklog: {
    ...
    weeks: [
      ...
      },
      {
        ...
        highlights: {
          en: ["EC2 & S3 Mastery", "Lambda Functions", "Project Scoping"],
          vi: ["Thành thạo EC2 & S3", "Lambda Functions", "Định phạm vi dự án"],
        },
      },
      {
        week: 3,
        ...
        highlights: {
          ...
          vi: ["Thiết kế hệ thống", "Sơ đồ kiến trúc", "Tài liệu kỹ thuật"],
        },
      },
      {
        week: 4,
        ...
        highlights: {
          en: ["API Gateway", "Lambda Integration", "DynamoDB Setup"],
          vi: ["API Gateway", "Tích hợp Lambda", "Cài đặt DynamoDB"],
        },
      },
      {
        week: 5,
        ...
        highlights: {
          en: ["SageMaker Setup", "Model Deployment", "Inference Pipeline"],
          vi: ["Cài đặt SageMaker", "Triển khai mô hình", "Pipeline suy luận"],
        },
      },
      {
        week: 6,
        ...
        highlights: {
          en: ["IAM Policies", "VPC Security", "Data Encryption"],
          vi: ["Chính sách IAM", "Bảo mật VPC", "Mã hóa dữ liệu"],
        },
      },
      {
        week: 7,
        ...
        highlights: {
          en: ["React Dashboard", "Real-time Monitoring", "Data Visualization"],
          vi: [
            "Dashboard React",
      ...
      },
      {
        ...
        highlights: {
          en: ["Unit Testing", "Integration Tests", "Security Audits"],
          vi: ["Unit Testing", "Integration Tests", "Audit bảo mật"],
        },
      },
      {
        week: 9,
        ...
        highlights: {
          en: ["Latency Reduction", "Cost Optimization", "Caching Strategies"],
          vi: ["Giảm độ trễ", "Tối ưu chi phí", "Chiến lược cache"],
        },
      },
      {
        week: 10,
        ...
        highlights: {
          en: ["API Documentation", "User Guides", "Architecture Docs"],
          vi: ["Tài liệu API", "Hướng dẫn người dùng", "Tài liệu kiến trúc"],
        },
      },
      {
        week: 11,
        ...
        highlights: {
          en: ["CodePipeline", "Production Deployment", "Monitoring Setup"],
          vi: ["CodePipeline", "Triển khai Production", "Thiết lập giám sát"],
        },
      },
      {
        week: 12,
        ...
        highlights: {
          en: ["Project Presentation", "Knowledge Transfer", "Final Report"],
          vi: [
            "Thuyết trình dự án",
  ...
  proposal: {
    ...
    services: [
      {
        name: "AWS Lambda",
        purpose: { en: "Serverless compute", vi: "Tính toán serverless" },
      },
      {
        name: "Amazon SageMaker",
        purpose: { en: "ML model hosting", vi: "Lưu trữ mô hình ML" },
      },
      {
        name: "Amazon DynamoDB",
        purpose: { en: "NoSQL database", vi: "Cơ sở dữ liệu NoSQL" },
      },
      {
        name: "Amazon API Gateway",
        purpose: { en: "API management", vi: "Quản lý API" },
      },
      {
        name: "Amazon CloudWatch",
        purpose: { en: "Monitoring & logging", vi: "Giám sát & ghi log" },
      },
      {
        name: "AWS IAM",
        purpose: { en: "Access management", vi: "Quản lý truy cập" },
      },
    ],
  },
  events: {
    ...
    list: [
      {
        name: {
          en: "AWS Cloud Practitioner Workshop",
          vi: "Workshop AWS Cloud Practitioner",
        },
        date: "2026-01-15",
        location: { en: "AWS Office, HCMC", vi: "Văn phòng AWS, TP.HCM" },
        role: { en: "Participant", vi: "Người tham gia" },
        description: {
          en: "Comprehensive introduction to AWS cloud services and best practices.",
          vi: "Giới thiệu toàn diện về các dịch vụ AWS cloud và best practices.",
        },
      },
      {
        ...
        role: { en: "Participant", vi: "Người tham gia" },
        description: {
          en: "Hands-on training with SageMaker, Bedrock, and other AI services.",
          vi: "Đào tạo thực hành với SageMaker, Bedrock và các dịch vụ AI khác.",
        },
      },
      {
        name: {
          en: "Security Best Practices Seminar",
          vi: "Hội thảo Best Practices Bảo mật",
        },
        date: "2026-02-20",
        location: { en: "AWS Office, HCMC", vi: "Văn phòng AWS, TP.HCM" },
        role: { en: "Presenter", vi: "Diễn giả" },
        description: {
          en: "Presented NeuraX Shield architecture and security implementation strategies.",
          vi: "Trình bày kiến trúc NeuraX Shield và chiến lược triển khai bảo mật.",
        },
      },
      {
        ...
        description: {
          en: "Shared internship experience and project learnings with the FCJ community.",
          vi: "Chia sẻ kinh nghiệm thực tập và bài học dự án với cộng đồng FCJ.",
        },
      },
    ],
  },
  workshop: {
    ...
    toc: [
      ...
      {
        id: "prerequisites",
        label: { en: "Prerequisites", vi: "Điều kiện tiên quyết" },
      },
  ...
  evaluation: {
    ...
    criteria: [
      {
        name: { en: "Technical Knowledge", vi: "Kiến thức Kỹ thuật" },
        rating: "good",
        comment: {
          en: "Strong understanding of AWS services and cloud architecture",
          vi: "Hiểu biết sâu về các dịch vụ AWS và kiến trúc cloud",
        },
      },
      {
        name: { en: "Learning Ability", vi: "Khả năng Học hỏi" },
        rating: "good",
        comment: {
          en: "Quick to adapt to new technologies and frameworks",
          vi: "Nhanh chóng thích nghi với các công nghệ và framework mới",
        },
      },
      {
        name: { en: "Proactivity", vi: "Chủ động" },
        rating: "good",
        comment: {
          en: "Consistently took initiative on tasks and improvements",
          vi: "Luôn chủ động trong công việc và cải tiến",
        },
      },
      {
        name: { en: "Discipline", vi: "Kỷ luật" },
        rating: "good",
        comment: {
          en: "Met all deadlines and followed processes diligently",
          vi: "Đáp ứng tất cả deadline và tuân thủ quy trình",
        },
      },
      {
        ...
        rating: "fair",
        comment: {
          en: "Clear technical communication, improving soft skills",
          vi: "Giao tiếp kỹ thuật rõ ràng, đang cải thiện kỹ năng mềm",
        },
      },
      {
        name: { en: "Teamwork", vi: "Làm việc nhóm" },
        rating: "good",
        comment: {
          en: "Collaborated effectively with team members",
          vi: "Hợp tác hiệu quả với các thành viên trong nhóm",
        },
      },
      {
        name: { en: "Problem Solving", vi: "Giải quyết vấn đề" },
        rating: "good",
        comment: {
          en: "Analytical approach to debugging and optimization",
          vi: "Tiếp cận phân tích để debug và tối ưu hóa",
        },
      },
      {
        name: { en: "Project Contribution", vi: "Đóng góp Dự án" },
        rating: "good",
        comment: {
          en: "Delivered core features and documentation",
          vi: "Hoàn thành các tính năng cốt lõi và tài liệu",
        },
      },
    ],
  },
